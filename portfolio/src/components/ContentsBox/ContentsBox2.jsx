          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li className='sub-entry'>
                  <a href='#content-header'>
                    <span className='content__number'>2.1</span>
                    <span>Choose Your Own Adventure</span>
                  </a>
                </li>
                <li className='sub-entry'>
                  <a href='#content-header'>
                    <span className='content__number'>2.2</span>
                    <span>EbayProductDescription</span>
                  </a>
                </li>
                <li className='sub-entry'>
                  <a href='#content-header'>
                    <span className='content__number'>2.3</span>
            ...
            <li>
              ...
              <ul>
                <li className='sub-entry'>
                  <a href='#content-header'>
                    <span className='content__number'>3.1</span>
                    <span>Galvanize Inc.</span>
                  </a>
                </li>
                <li className='sub-entry'>
                  <a href='#content-header'>
                    <span className='content__number'>3.2</span>
                    <span>Eat Club</span>
                  </a>
                </li>
                <li className='sub-entry'>
                  <a href='#content-header'>
                    <span className='content__number'>3.3</span>
            ...
            <li>
              ...
              <ul>
                <li className='sub-entry'>
                  <a href='#content-header'>
                    <span className='content__number'>4.1</span>
                    <span>Hack Reactor</span>
                  </a>
                </li>
                <li className='sub-entry'>
                  <a href='#content-header'>
                    <span className='content__number'>4.2</span>
