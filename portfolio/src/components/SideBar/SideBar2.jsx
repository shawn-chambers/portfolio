      ...
      {/* <SideBarContainer> */}
        <div className="side-bar">
          <div className='side-bar__menu'>
            ...
            <div className='side-bar__menu--header-mini'><span>S</span><span>HAWN CHAMBER</span><span>S</span></div>
            <div className='side-bar__menu--sub-header-mini'>Web Developer - CA</div>
          </div>
